...
SIGNATURE_CORE_CACHE_RECORD_SCHEMA = _cache_version("sig_core.v7")
SIGNATURE_FEATURES_CACHE_RECORD_SCHEMA = _cache_version("sig_feat")
SIGNATURE_OUTPUT_CACHE_RECORD_SCHEMA = _cache_version("sig_output.v4")
FUNCTION_CACHE_RECORD_SCHEMA = _cache_version("fn_core")
POLICY_CONSTANT_CACHE_RECORD_SCHEMA = _cache_version("policy_const")
...
RELATION_DETAIL_CACHE_VALUE_VERSION = _cache_version("rel_detail_value")
